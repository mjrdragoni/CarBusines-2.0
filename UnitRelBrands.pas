...
type
  TFrmRelBrands = class(TFrmPatternRel)
    NomeDe: TLabeledEdit;
...
var
  FrmRelBrands: TFrmRelBrands;

implementation

{$R *.dfm}

procedure TFrmRelBrands.btncancelrelClick(Sender: TObject);
begin
  inherited;
    edtCodigoDe.Clear;
    edtCodigoAte.Clear;
...
procedure TFrmRelBrands.btnprintClick(Sender: TObject);
Var StrLiga : String;
begin
  inherited;
    StrLiga := 'where ';
