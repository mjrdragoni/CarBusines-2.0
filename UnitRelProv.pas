...
type
  TFrmRelProv = class(TFrmPatternRel)
    NomeDe: TLabeledEdit;
...
var
  FrmRelProv: TFrmRelProv;

implementation

{$R *.dfm}

procedure TFrmRelProv.btncancelrelClick(Sender: TObject);
begin
  inherited;
edtCodigoDe.Clear;
    edtCodigoAte.Clear;
...
procedure TFrmRelProv.btnprintClick(Sender: TObject);
Var StrLiga : string;
begin
  inherited;
StrLiga := 'where ';
